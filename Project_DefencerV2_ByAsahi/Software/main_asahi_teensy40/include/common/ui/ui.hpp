...
void ui_main()
{
    ...
    if(btRight.isPushed())
    {
        ...
        else if(now_length == 2)
        {
            ...
            {
                middle_page = (MIDDLE_PAGETYPE)((((int)middle_page - 20 + 1) % 8) + 20);
            }
    ...
    if(btLeft.isPushed())
    {
        ...
        else if(now_length == 2)
        {
            ...
            {
                middle_page = (MIDDLE_PAGETYPE)((((int)middle_page - 20 + 7) % 8) + 20);
            }
            else if(toppage == TOP_PAGETYPE::SETTINGS)
            {
                middle_page = (MIDDLE_PAGETYPE)((((int)middle_page - 30 + 1) % 2) + 30);
    ...
    else if(now_length == 2)
    {
        switch(middle_page)
        {
            ...
            case MIDDLE_PAGETYPE::YELLOW:
                {
                    ...
                    if(btEnter.isPushed())
                    {
                        ...
                        engelline.bIsLineHalfOut = false;
                        engelline.Line_Timer.reset();
                        engelline.Line_Timer.stop();
                        engelline.bIsAbleToDisturb = false;
                        engelline.bIsMaybeHalfOut = false;
                    }
                }
                break;
            ...
            case MIDDLE_PAGETYPE::DRIBBLER_TEST:
                {
                    display.fillRect(0, 0, 128, 15, SSD1306_WHITE);
                    ...
                    if(Dribbler_RollType == 0)
                    {
                        display.setCursor(24, 32);
                        display.setTextSize(2);
                        display.println("SPEED:1000");
                        
                        Dribbler.writeMicroseconds(1000);
                    }
                    else if(Dribbler_RollType == 1)
                    {
                        display.setCursor(24, 32);
                        display.setTextSize(2);
                        display.println("SPEED:1100");
                        
                        Dribbler.writeMicroseconds(1100);
                    }
                    else if(Dribbler_RollType == 2)
                    {
                        display.setCursor(24, 32);
                        display.setTextSize(2);
                        display.println("SPEED:1200");
                    ...
                    if(btEnter.isPushed())
                    {
                       Dribbler_RollType = (Dribbler_RollType + 1) % 3;
                    }
                }
                break;
